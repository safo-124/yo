...
export default function StaffRegistryClaimsView({
  ...
  const handlePrintClaim = () => { 
      ...
      if(printWindow){
        ...
        const printHtml = `<html><head><title>Claim Voucher - ${claim.id}</title><meta charset="UTF-8"><style>
        ...
        <div class="print-container">
            ...
            <div class="section">
                ...
                <div class="details-grid">
                    ...
                    <span><strong>${claim.submittedBy?.name||'N/A'}</strong> (${claim.submittedBy?.email||'N/A'})</span>
            ...
            ${claim.processedAt?`<div class="section section-alt">
                ...
                <div class="details-grid">
                    ...
                    <span><strong>${claim.processedBy?.name||'N/A'}</strong> (${claim.processedBy?.email||'N/A'})</span>
