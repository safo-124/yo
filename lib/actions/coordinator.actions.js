...
export async function assignCoursesToLecturerByCoordinator({ lecturerId, courseIds, coordinatorId }) {
  ...
  try {
    ...
    console.log(`[${timestamp}] [assignCoursesToLecturerByCoordinator] Successfully assigned ${courseIds.length} courses to ${user.name} (${user.role}).`);
